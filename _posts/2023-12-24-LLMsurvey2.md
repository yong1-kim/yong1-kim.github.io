...
# 5.1. <span style='background-color: #dcffe4'> Instruction Tuning </span>
...
# 5.2. <span style='background-color: #dcffe4'> Alignment Tuning </span>
...
# 5.3. <span style='background-color: #dcffe4'> Parameter-Efficient Model Adaptation </span> 
# 5.3.1. Parameter-Efficient Fine-Tuning Methods
# 5.3.2. Parameter-Efficient Fine-Tuning on LLMs


# 5.4. <span style='background-color: #dcffe4'> Memory-Efficient Model Adaptation </span>
